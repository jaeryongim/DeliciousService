class FoodsController < ApplicationController
  before_action :login_check, except: [ :posts, :posts_category, :show]
  ...
  def show
    ...
    @comment_writer = User.where(id: session[:user_id]).first
  end
  ...
  def write_complete
    ...
    if post.save
      ...
      flash[:alert] = post.errors.instance_values.flatten.join(' ')
      redirect_to :back
    end
  end
